...
//                public void Pressure_Points(ref List<List<Point>> Pts, ref List<List<MathNet.Numerics.Complex>> Pressure, int[] X, int[] Y, int[] Z, double Low_P, bool Volume, bool Vectored, bool Colored)
//                {
...
//                {
//                    public MathNet.Numerics.Complex U;
//                    public P_Node N1;
//                    public P_Node N2;

//                    public U_Node() { }
//                    public abstract void Update();
//                    public virtual MathNet.Numerics.Complex U1
//                    {
//                        get { return U; }
//                    }
//                    public virtual MathNet.Numerics.Complex U2
//                    {
//                        get { return U; }
//                    }
//                }
...
//                        //{
//                        //    Rhino.RhinoDoc.ActiveDoc.Objects.Add(new LineCurve(Utilities.PachTools.HPttoRPt(N1.Pt), Utilities.PachTools.HPttoRPt(N2.Pt)));
//                        //}
//                        U -= coef * (N2.P - N1.P);
...
//                //    public override MathNet.Numerics.Complex U1
//                //    {
//                //        get
//                //        {
//                //            return Uminus;
...
//                    MathNet.Numerics.Complex U1_Sum, U2_Sum;
//                    double KT;
//                    double alpha;
//                    double betacoef;
//                    MathNet.Numerics.Complex Uminus;
...
//                    public Point Pt;
//                    public MathNet.Numerics.Complex Pa;
...
//                    {
//                        Vector V = new Vector((Xpos_Link.U - Xneg_Link.U).Modulus, (Ypos_Link.U - Yneg_Link.U).Modulus, (Zpos_Link.U - Zneg_Link.U).Modulus);
//                        V.Normalize();
//                        return V;
//                    }
...
//                public Signal_Driver_complex(Signal_Type S_in, double freq, double w_in, Point[] Loc_in, double Delay)
//                {
//                    delay = Delay;
//                    S = S_in;
//                    f = freq;
...
//                public Microphone_complex(Point[] Loc_in)
//                {
//                    Loc = Loc_in;
//                    Random R = new Random();
