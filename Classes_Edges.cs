...
//                ////////////////////////////
//                //VisCheck//
//                Point pt = new Point(Z_mid.x, Z_mid.y, Z_mid.z);
//                Rhino.RhinoDoc.ActiveDoc.Objects.AddLine(pt, pt + new Point(Normal[0].x, Normal[0].y, Normal[0].z));
//                Rhino.RhinoDoc.ActiveDoc.Objects.AddLine(pt, pt + new Point(Normal[1].x, Normal[1].y, Normal[1].z));
//                //Rhino.RhinoDoc.ActiveDoc.Objects.AddLine(pt, pt + new Point(Tangent[0].x, Tangent[0].y, Tangent[0].z));
//                //Rhino.RhinoDoc.ActiveDoc.Objects.AddLine(pt, pt + new Point(Tangent[1].x, Tangent[1].y, Tangent[1].z));
//                //////Rhino.RhinoDoc.ActiveDoc.Objects.AddPoint(new Point(Z_mid.x, Z_mid.y, Z_mid.z));
//            }
...
//        public Edge_Straight(ref IEnumerable<Hare.Geometry.Point> SPT, ref IEnumerable<Hare.Geometry.Point> RPT, Environment.Medium_Properties Att_Props, Brep[] Brep, int[] Brep_Index, Curve Be)
//            : base(Brep, Be)
//        {
...
//            Point PA = Be.PointAtStart;
//            Point PB = Be.PointAtEnd;
...
//            Intersect.Intersection.BrepPlane(Brep[0], P, 0.01, out Csects1, out Psects);
//            Intersect.Intersection.BrepPlane(Brep[1], P, 0.01, out Csects2, out Psects);

//            Rhino.RhinoDoc.ActiveDoc.Objects.Add(Csects1[0]);
//            Rhino.RhinoDoc.ActiveDoc.Objects.Add(Csects2[0]);

//            Vector[] Tangents = new Vector[2];
...
//                //double DeltaZ = Env_Props.Sound_Speed(Point.Origin) / (4 * fs);
//                Intersect.Intersection.BrepPlane(B[0], P, 0.001, out Csects1, out Psects);
//                Intersect.Intersection.BrepPlane(B[1], P, 0.001, out Csects2, out Psects);
//                Vector[] Tangents = new Vector[2];
//                ///Control Start Point of curve
//                if ((Csects1[0].PointAtStart.x * P.Origin.x + Csects1[0].PointAtStart.y * P.Origin.y + Csects1[0].PointAtStart.z * P.Origin.z) < 0.00001) Csects1[0].Reverse();
//                if ((Csects2[0].PointAtStart.x * P.Origin.x + Csects2[0].PointAtStart.y * P.Origin.y + Csects2[0].PointAtStart.z * P.Origin.z) < 0.00001) Csects2[0].Reverse();
...
//                Point outPt;
//                Vector[] Normals = new Vector[2];
//                //Point CPT = Utilities.PachTools.HPttoRPt(Z_mid);
