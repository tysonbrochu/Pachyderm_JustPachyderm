...
//                        M[0, 1] = -Complex.I * k13 * Complex.Sin(k13 * h);
//                        M[0, 2] = -Complex.I * k13 * Mu1 * Complex.Sin(k13 * h);
//                        M[0, 3] = -D1 * Complex.Cos(k13 * h);
//                        M[0, 4] = 2 * Complex.I * ShearModulus * kt * k13 * Complex.Sin(k13 * h);
//                        M[0, 5] = -E1 * Complex.Cos(k13 * h);
//                        M[1, 0] = -Complex.I * w * kt * Complex.Sin(k13 * h);
//                        M[1, 1] = w * k13 * Complex.Sin(k13 * h);
//                        M[1, 2] = w * k13 * Mu1 * Complex.Sin(k13 * h);
//                        M[1, 3] = Complex.I * D1 * Complex.Sin(k13 * h);
//                        M[1, 4] = -2 * ShearModulus * kt * k13 * Complex.Cos(k13 * h);
//                        M[1, 5] = Complex.I * E1 * Complex.Sin(k13 * h);

//                        M[2, 0] = w * kt * Complex.Cos(k23 * h);
//                        M[2, 1] = -Complex.I * k23 * Complex.Sin(k23 * h);
//                        M[2, 2] = -Complex.I * k23 * Mu2 * Complex.Sin(k23 * h);
//                        M[2, 3] = -D2 * Complex.Cos(k23 * h);
//                        M[2, 4] = 2 * Complex.I * ShearModulus * kt * k23 * Complex.Sin(k23 * h);
//                        M[2, 5] = -E2 * Complex.Cos(k23 * h);
//                        M[3, 0] = -Complex.I * w * kt * Complex.Sin(k23 * h);
//                        M[3, 1] = w * k23 * Complex.Sin(k23 * h);
//                        M[3, 2] = w * k23 * Mu2 * Complex.Sin(k23 * h);
//                        M[3, 3] = Complex.I * D1 * Complex.Sin(k23 * h);
//                        M[3, 4] = -2 * ShearModulus * kt * k23 * Complex.Cos(k23 * h);
//                        M[3, 5] = Complex.I * E2 * Complex.Sin(k23 * h);

//                        M[4, 0] = Complex.I * k33 * Complex.Sin(k33 * h);
//                        M[4, 1] = w * kt * Complex.Cos(k33 * h);
//                        M[4, 2] = w * kt * Mu3 * Complex.Cos(k33 * h);
//                        M[4, 3] = 2 * Complex.I * ShearModulus * k33 * kt * Complex.Sin(k33 * h);
//                        M[4, 4] = ShearModulus * (k33 * k33 - kt * kt) * Complex.Cos(k33 * h);
//                        M[4, 5] = 0;
//                        M[5, 0] = -w * k33 * Complex.Cos(k33 * h);
//                        M[5, 1] = -Complex.I * w * kt * Complex.Sin(k33 * h);
//                        M[5, 2] = -Complex.I * 2 * kt * Mu3 * Complex.Sin(k33 * h);
//                        M[5, 3] = -2 * ShearModulus * k33 * kt * Complex.Cos(k33 * h);
//                        M[5, 4] = -Complex.I * ShearModulus * (k33 * k33 - kt * kt) * Complex.Sin(k33 * h);
//                        M[5, 5] = 0;
...
//                        M[0, 0] = -B2 * 2 * ShearModulus * w * kt / (Complex.I * Y);
//                        //M[0,1] = 
//                        //M[0,2] = 
...
//                        //M[1,0] = 
//                        M[1, 1] = -((1 + Mu1 / Mu21) - 2 * w * w * kt * kt * (1 - Mu31 / Mu21) / (kt * kt)) / (Complex.I * k13);
//                        M[1, 2] = 1 / (k13 * Mu21);
//                        //M[1,3] = 
//                        M[1, 4] = -w * kt * (1 - (Mu31 / Mu21)) / (k13 * ShearModulus * kt * kt);
//                        //M[1,5] = 
//                        M[2, 0] = (B1 * 2 * ShearModulus * w * kt) / (Complex.I * Y);
//                        //M[2,1] = 
//                        //M[2,2] = 
...
//                        //M[3,0] = 
//                        M[3, 1] = (Mu1 / Mu21 + 2 * (w * w * kt * kt * Mu31) / (kt * kt * Mu21)) / (Complex.I * k23); ///Shown in paper as simply alpha... alpha2 = k23 in Atalla's work... 
//                        M[3, 2] = -1 / (Complex.I * k23 * Mu21);
//                        //M[3,3] = 
//                        M[3, 4] = -(w * w * kt * kt * Mu31) / (k23 * ShearModulus * kt * kt * Mu21);
//                        //M[3,5] =                                                 M[0,0] = 
//                        //M[0,4] =
//                        M[4, 1] = -(2 * w * w * kt * kt) / (Complex.I * kt * kt);
//                        //M[4,2] = 
//                        //M[4,3] = 
//                        M[4, 4] = 1 / (ShearModulus * kt * kt);
//                        //M[4,5] =
//                        M[5, 0] = X / (Complex.I * k33 * Y);
//                        //M[5,1] = 
//                        //M[5,2] = 
...
//                        M[0, 0] = coskzh;
//                        M[0, 1] = (Complex.I * kz / pr2) * sinkzh;
//                        M[1, 0] = (Complex.I * pr2 / kz) * sinkzh;
//                        M[1, 1] = coskzh;
...
//                        MH[0, 0] = wk1 * cosk13h;
//                        MH[0, 1] = -Complex.I * wk13 * cosk13h;
//                        MH[0, 2] = -D1 * cosk13h;
//                        MH[0, 3] = Complex.I * D2k13 * sink13h;
//                        MH[1, 0] = -Complex.I * wk1 * sink13h;
//                        MH[1, 1] = wk13 * cosk13h;
//                        MH[1, 2] = Complex.I * D1 * sink13h;
//                        MH[1, 3] = -D2k13 * cosk13h;
//                        MH[2, 0] = Complex.I * wk33 * sink33h;
//                        MH[2, 1] = wk1 * cosk33h;
//                        MH[2, 2] = Complex.I * D2k33 * sink33h;
//                        MH[2, 3] = D1 * cosk33h;
//                        MH[3, 0] = -wk33 * cosk33h;
//                        MH[3, 1] = -Complex.I * wk1 * sink33h;
//                        MH[3, 2] = -D2k33 * cosk33h;
//                        MH[3, 3] = -Complex.I * D1 * sink33h;
