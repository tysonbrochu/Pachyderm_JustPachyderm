...
//                        {                                
//                             Map_Mesh.Vertices[i] = new Point(Map_Mesh.Vertices[i].x + (float)V.x,
...
//                            for (int i = 0; i < Map_Mesh.Vertices.Count; i++)
//                            {
//                                Vector V = new Vector((float)(Map_Mesh.Normals[i].x * increment * .5), (float)(Map_Mesh.Normals[i].y * increment * .5), (float)(Map_Mesh.Normals[i].z * increment * .5));
...
//                                Vector V = new Vector((float)(Map_Mesh.FaceNormals[i].x * increment * .5), (float)(Map_Mesh.FaceNormals[i].y * increment * .5), (float)(Map_Mesh.FaceNormals[i].z * increment * .5));
...
//            //        //foreach (int S_ID in SrcID)
//            //        //{
//            //        //    Rhino.RhinoDoc.ActiveDoc.Objects.AddCurve(new LineCurve(new Point(Rec_List[S_ID].Rec_List[i].H_Origin.x, Rec_List[S_ID].Rec_List[i].H_Origin.y, Rec_List[S_ID].Rec_List[i].H_Origin.z), new Point(Rec_List[S_ID].Rec_List[i].H_Origin.x + V.x, Rec_List[S_ID].Rec_List[i].H_Origin.y + V.y, Rec_List[S_ID].Rec_List[i].H_Origin.z + V.z)));
//            //        //}
//            //    }
//            //}
