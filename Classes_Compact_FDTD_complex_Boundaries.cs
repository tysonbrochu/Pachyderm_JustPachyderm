...
//                    Boundary Flags;
//                    MathNet.Numerics.Complex ab1 = 0;
//                    MathNet.Numerics.Complex abDenom = 0;
//                    int[] id;
...
//                    public override void Link_Nodes(ref P_Node[][][] Frame, int x, int y, int z)
//                    {
//                        MathNet.Numerics.Complex[] abs_poles = new MathNet.Numerics.Complex[] { new MathNet.Numerics.Complex(-0.212854, -0.285357), new MathNet.Numerics.Complex(-.212854, 0.285357) };
//                        MathNet.Numerics.Complex[] abs_zeros = new MathNet.Numerics.Complex[] { 0.876, 0.876 };

//                        MathNet.Numerics.Complex[] ref_poles = new MathNet.Numerics.Complex[] { new MathNet.Numerics.Complex(0, 0), new MathNet.Numerics.Complex(0, 0) };
//                        MathNet.Numerics.Complex[] ref_zeros = new MathNet.Numerics.Complex[] { new MathNet.Numerics.Complex(0, 0), new MathNet.Numerics.Complex(0, 0) };
...
//                        double[] ax;
//                        double[] bx;
//                        MathNet.Numerics.Complex[] xx;
//                        MathNet.Numerics.Complex[] yx;
//                        MathNet.Numerics.Complex rec_b0;
//                        MathNet.Numerics.Complex gn;
//                        double interp;

//                        public DIF_IWB_2p(MathNet.Numerics.Complex[] Poles, MathNet.Numerics.Complex[] Zeros, double scale, double M)
//                            : this(Poles, Zeros, scale)
//                        {
//                            interp = M;
//                        }

//                        public DIF_IWB_2p(MathNet.Numerics.Complex[] Poles, MathNet.Numerics.Complex[] Zeros, double scale, IWB_Mask M)
//                            : this(Poles, Zeros, scale)
//                        {
//                            switch (M)
//                            {
...
//                        public DIF_IWB_2p(MathNet.Numerics.Complex[] Poles, MathNet.Numerics.Complex[] Zeros, double scale)
//                        {
//                            ax = new double[3];
//                            ax[0] = 1;
...
//                            rec_b0 = 1 / bx[0];
//                            a_b = ax[0] / bx[0];
//                            xx = new MathNet.Numerics.Complex[2];
//                            yx = new MathNet.Numerics.Complex[2];
//                        }

//                        public override MathNet.Numerics.Complex g_b_term()
//                        {
...
//                        /// </summary>
//                        /// <param name="Pn"></param>
//                        public override void Update(MathNet.Numerics.Complex Pnf, MathNet.Numerics.Complex Pn_1)
//                        {
//                            xx[1] = xx[0];
//                            yx[1] = yx[0];
...
//                        public MathNet.Numerics.Complex A0
//                        {
//                            get { return ax[0]; }
//                        }

//                        public MathNet.Numerics.Complex B0
//                        {
//                            get { return bx[0]; }
//                        }
//                    }
...
//                    {
//                        public MathNet.Numerics.Complex a_b;
//                        protected int[] DIR;
...
//                        public abstract MathNet.Numerics.Complex g_b_term();
//                        //public Complex ab;
//                        public abstract void Update(MathNet.Numerics.Complex Pnf, MathNet.Numerics.Complex Pn_1);
//                    }
